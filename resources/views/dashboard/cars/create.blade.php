    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.users.index') }}"> @lang('site.cars')</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.cars.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="type" class="form-control" placeholder="ادخل اسـم و نـوع السيارة" value="{{ old('type') }}" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control" value="{{ old('price') }}" placeholder="ادخل سعـر السيارة">
                        </div>
                        <div class="form-group">
                            <label>@lang('site.color')</label>
                            <input type="text" name="color" class="form-control" value="{{ old('color') }}" placeholder="ادخل لون السيارة">
                        </div>
                        <div class="form-group">
                            <label>@lang('site.year')</label>
                            <input type="number" name="year" class="form-control" value="{{ old('year') }}" placeholder="ادخل موديل سنة السيارة">
                        </div>
                        <div class="form-group">
                            <label>@lang('site.new')</label>
                            <select name="new" id="status_car" value="{{ old('new') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Auction_type" value="{{ old('Auction_type') }} id="mazad_fawery_car" >
                        ...
                        <div class="form-group">
                            ...
                            <select name="Guarant" value="{{ old('Guarant') }} >
                                ...
                                <option value="2">بـدون  ضمـان</option>
                            </select>
                        </div>
                        <div class="form-group">
