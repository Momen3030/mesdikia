@include('Headers.carproductdetails_header');
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="product_content">
                    <h4> تفـاصيـل أكثر عن العقـار<hr></h4>
                    <div class="row">
                        <div class="col-6">
                            <div class="input-group">
                                <label for="type_build">نـوع العقـار</label>
                            <label class="product_data" name="">{{$_GET['type']}}</label>
                            </div>
                            <div class="input-group">
                                    <label for="build_size">  مسـاحة العقـار</label>
                            <label class="product_data" name="">{{$_GET['SizeInMeter']}}</label>
                            </div>
                            <div class="input-group">
                                    <label for="floor_num"> عـدد الطوابق</label>
                            <label class="product_data" name="">{{$_GET['floors']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="room"> عـدد الغـرف </label>
                            <label class="product_data" name="">{{$_GET['rooms']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="status_car">حـالـة العقـار</label>
                            <label class="product_data" name="">{{$_GET['new']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="status_car">ضمان العقـار</label>
                        ...
                        <div class="col-6 col-md-3">
                            <h5 class="text-center">سعـر العقـار<hr class="ln" /></h5>
                ...
                <hr/>
                <a href="#" class="btn btn-primary btn_buy"> <i class="fa fa-shopping-cart"></i>  شـراء العقـار </a>
            </div>
        </div>
    </div>
</section>
