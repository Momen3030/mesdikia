        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="product_content">
                    <h4> تفـاصيـل أكثر عن السيـارة<hr></h4>

                    <div class="row">
                        <div class="col-6">
                            <div class="input-group">
                                <label for="type_car">نـوع السيـارة</label>
                                <label class="product_data" name="">{{$_GET['type']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="color_car">لـون السيـارة</label>
                                <label class="product_data" name="">{{$_GET['color']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="model_car">مـوديل السيـارة</label>
                                <label class="product_data" name="">{{$_GET['model']}}</label>
                            </div>
                            <div class="input-group">
                                <label for="status_car">حـالـة السيـارة</label>
                ...
                <hr/>
                <a href="#" class="btn btn-primary btn_buy"> <i class="fa fa-shopping-cart"></i>  شـراء السيـارة </a>
            </div>
