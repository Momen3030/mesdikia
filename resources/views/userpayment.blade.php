    ...
    <div class="card-body">
        <div class="container">
            <div class="row" >
                ...
                <div class="col-md-6">
                    <h4 class="text-center"> User Payment<hr class="ln"/></h4>
                    <div class="forms">

                        <!-- ====================================== -->
                        <form action="{{url('/contiuepayment')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="street1" class="form-control" placeholder="street" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="postcode" class="form-control" placeholder="ZIP" required >
                            </div>
                            <div class="input-group mb-3">
                                <input type="email" name="email" class="form-control" placeholder="email" required>
                            </div>
                            <div class="input-group mb-3">
                                <input type="number" name="price" class="form-control" placeholder="Amount" value="4562" required>
                            </div>
                            <input type="submit" value="continue" class="btn btn-outline-primary btn-block btn_sub" >
{{--                            <a class="btn btn-outline-primary btn-block btn_sub" href="{{url('/contiuepayment')}}">continue</a>--}}
